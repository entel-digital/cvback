    ...
    <q-card class="my-card" flat bordered>
      ...
      <q-card-section horizontal>
        <q-card-section class=" col-3">
          <div class="q-px-xs q-py-sm q-gutter-xs column no-warp">
          <q-btn no-caps color="primary" label="Hoy" />
          <q-btn no-caps color="primary" label="Ayer" />
          <q-btn no-caps color="primary" label="Semana" />
          <q-btn no-caps color="primary" label="Mes" />
          <q-btn no-caps color="primary" label="Año" />
        </div>
        </q-card-section>
